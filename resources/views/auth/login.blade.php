...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="{{ asset('css/smartadmin/intro.js/introjs.css') }}">
...
<body class="mod-bg-1 mod-nav-link footer-function-fixed nav-function-minify nav-function-fixed">
    ...
    <!-- intro.js -->
    {{-- <script src="{{ asset('js/smartadmin/intro.js/minified/intro.min.js') }}"></script> --}}
    <script src="{{ asset('js/smartadmin/intro.js/intro.js') }}"></script>
    {{-- <script src="{{ asset('js/smartadmin/intro.js/minified/intro.min.js.map') }}"></script> --}}
