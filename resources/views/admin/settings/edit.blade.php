	...
	<div class="col-12">
		<div id="panel-1" class="panel panel-lock show" data-panel-sortable data-panel-close data-panel-collapsed>
			<form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                ...
                <div class="panel-hdr">
                    <h2>
                        {{ trans('cruds.setting.title') }} | <span class="fw-300"><i>Ubah</i></span>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('nm_org') ? 'is-invalid' : '' }}" type="text" name="nm_org" id="nm_org" value="{{ old('nm_org', $setting->nm_org) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat">{{ old('alamat', $setting->alamat) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('telepon') ? 'is-invalid' : '' }}" type="text" name="telepon" id="telepon" value="{{ old('telepon', $setting->telepon) }}">
